...
function resolveReferenceNode(schema: JsonSchemaObjectType, objectDefs: Map<string, SchemaObjectNodeData>): SchemaObjectNodeData | undefined {
    if (schema.$ref) {
