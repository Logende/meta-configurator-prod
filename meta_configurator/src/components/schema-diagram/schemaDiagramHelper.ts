...
import type {Node} from "@/components/schema-diagram/schemaDiagramTypes";
import {pathToString} from "@/utility/pathUtils";
import {SchemaElementData, SchemaObjectNodeData} from "@/components/schema-diagram/schemaDiagramTypes";
...
export function identifyBestMatchingData(selectedNode: Node|undefined, path: Path): SchemaElementData | undefined {
    if (!selectedNode) {
        return undefined;
    }
