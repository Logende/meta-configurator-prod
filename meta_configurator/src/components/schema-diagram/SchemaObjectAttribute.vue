...
function isHighlighted() {
    return pathToString(schemaSession.currentSelectedElement.value) === (pathToString(props.data.absolutePath));
}

</script>

<template>
    <div :class="{'bg-yellow-100': isHighlighted(), 'vue-flow__node-schemaattribute': !isHighlighted}"
    @click="clickedAttribute" v-on:click.stop>
