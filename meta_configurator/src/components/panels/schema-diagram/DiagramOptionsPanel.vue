...
<template>
  <Accordion :activeIndex="1">
    <AccordionTab
        header="Schema Diagram Options">


      <div>
        <label>Graph direction vertical
        <InputSwitch v-model="useSettings().schemaDiagram.vertical" label="Vertical" />
        </label>
      </div>
      <div>
        <label>Show attributes
        <InputSwitch v-model="useSettings().schemaDiagram.showAttributes" label="Automatic zoom" />
        </label>
      </div>
      <div>
      ...
      <div>
        <label>Move view on element selection
