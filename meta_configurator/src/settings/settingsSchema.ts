...
export const SETTINGS_SCHEMA: TopLevelSchema = {
  ...
  type: "object",
  required: ['dataFormat', 'guiEditorOnRightSide', 'codeEditor', 'guiEditor', 'metaSchema', 'panels'],
  ...
  properties: {
    ...
    guiEditorOnRightSide: {
      type: "boolean",
      description: "If enabled, the GUI editor will be on the right side and the code editor on the left. Otherwise, it will be the opposite way.",
      default: true
    },
    codeEditor: {
      type: "object",
    ...
    guiEditor: {
      ...
      properties: {
        maximumDepth: {
          type: "integer",
          description: "The maximum depth of the GUI editor. If the depth of the configuration object is higher, the GUI editor will not show the deeper levels, but they can be navigated by clicking on the property name",
          default: 5,
          minimum: 1,
          maximum: 20
        },
    ...
    metaSchema: {
      type: "object",
      required: ["allowBooleanSchema", "allowMultipleTypes", "showAdditionalPropertiesButton", "objectTypesComfort", "rootMustBeObject"],
      additionalProperties: false,
